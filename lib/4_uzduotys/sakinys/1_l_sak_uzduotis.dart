...
class SakinioLengva1 extends StatelessWidget {
  const SakinioLengva1({super.key});
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              player.play(AssetSource('l_s_uzd/Tupi.m4a'));
                                            },
                                          ),
                                        ]
                                    ),
                                    ...
                                    Column(
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () {
                                              final player = AudioPlayer();
                                              player.play(AssetSource('l_s_uzd/Šarka.mp3'));
                                            },
                                          ),
                                        ]
                                    ),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                            final player = AudioPlayer();
                                            player.play(AssetSource('l_s_uzd/Lesa.m4a'));
                                          },
                                        ),
                                      ],
                                    ),
                                    ...
                                    Column(
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () {
                                              final player = AudioPlayer();
                                              player.play(AssetSource('l_s_uzd/Skrenda.m4a'));
                                            },
                                          ),
                                        ]
                                    ),
                          ...
                          children: [
                            ElevatedButton(
                              ...
                              child: Icon(
                                ...
                                size: 70,),
                              onPressed: () {
                                Navigator.pushNamed(context, '/2_l_sakinio_u');
                              },
                            ),
                            const SizedBox(width: 10),
                          ]
