...
class SakinioLengva3 extends StatelessWidget {
  const SakinioLengva3({super.key});
                                  ...
                                  Column(
                                      children: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                            final player = AudioPlayer();
                                            player.play(AssetSource('l_s_uzd/Šeškas.m4a'));
                                          },
                                        ),
                                      ]
                                  ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () {
                                          final player = AudioPlayer();
                                          player.play(AssetSource('l_s_uzd/Valgo.m4a'));
                                        },
                                      ),
                                    ],
                                  ),
                                  ...
                                  Column(
                                      children: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                            final player = AudioPlayer();
                                            player.play(AssetSource('l_s_uzd/Eina.m4a'));
                                          },
                                        ),
                                      ]
                                  ),
